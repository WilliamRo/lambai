...
def load_data():
  ...
  datasets = PRAgent.load(th.data_dir, *th.train_val_test_indices(),
                          radius=th.radius, win_size=th.win_size)
...
def _dev0_loader():
  ...
  datasets = PRAgent.load(
    th.data_dir, 1, 2, 3, radius=th.radius, win_size=th.win_size)
